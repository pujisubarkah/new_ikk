// components/koorutama/KebijakanMasukTab.tsx
...
export default function KebijakanMasukTab({
  data,
  loading,
  error,
  currentPage,
  ...
  return (
    <>
      <h1 className="text-2xl font-bold text-gray-800 mb-6">Kebijakan Masuk</h1>

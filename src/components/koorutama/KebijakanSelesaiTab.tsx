// components/koorutama/KebijakanSelesaiTab.tsx
...
export default function KebijakanSelesaiTab({
  data,
  loading,
  error,
  currentPage,
  ...
  return (
    <>
      <h1 className="text-2xl font-bold text-gray-800 mb-6">Kebijakan Selesai</h1>

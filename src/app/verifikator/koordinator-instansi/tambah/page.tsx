...
const TambahPengguna: React.FC = () => {
  const [formData, setFormData] = useState<FormData>({
    ...
    instansi: "",
    email: "",
    role: "Admin Instansi", // Role set as Admin Instansi by default
    password: "",
    jabatan: "",
    telepon: "",
    status: "",
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 p-6 md:p-20">
        <h1 className="text-2xl font-bold mb-4">Tambah Admin Instansi</h1>
          ...
          <div className="grid gap-4 md:col-span-2">
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                required
                className="w-full max-w-xs border border-gray-300 rounded-md p-2" // Adjusted width here
                disabled
              >
